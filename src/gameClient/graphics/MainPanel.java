...
public class MainPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        drawAgents(g);
        drawInfo(g);
        //updateW2f(panelWidth, panelHeight);
...
//        getGraphics().drawString();game.timeToEnd()/1000
    }
//    private void updateFrame() {
//        Range rx = new Range(800, this.getWidth() -43);
//        Range ry = new Range(this.getHeight()-43, 800);
...
//            private void drawInfo2(Graphics g) {
...
//                g.drawString("time left : " + time + "s", this.getWidth() - 150, 50);
    ...
    private void drawGraph(Graphics g) {
        directed_weighted_graph graph = arena.getGraph();
        //g.drawString("Time to end: " + game.timeToEnd()/1000, 100, 100);
...
//                g.fillOval(x, y, w, h);
    ...
    private void drawAgents(Graphics g) {
        ...
        while (agents != null && i < agents.size()) {
            ...
            int r = 20;
//            g.drawString("Score agent "+ agents.get(i).getID()+": " + agents.get(i).getValue(), 2*r-3,2*r-3 );
//            System.out.println("");
            i++;
            if (c != null) {
    ...
    private void drawScore(Graphics g) {
        ...
        for (CL_Agent agent : agents) {
            ...
            g.drawString("Score agent " + agent.getID() + ": " + agent.getValue(), this.getWidth()  -400, this.getHeight()-650 + count);
            count += 20;
        ...
        g.drawString("Total Score: " + score, this.getWidth()  -400,this.getHeight()-640 + count );
